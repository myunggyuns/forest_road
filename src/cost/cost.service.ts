...
import { Cost } from 'src/entity/cost/cost.entity';

@Injectable()
export class CostService {
  constructor(private readonly configService: ConfigService, @Inject('COST_REPOSITORY') private costRepository: Repository<Cost>) {}
